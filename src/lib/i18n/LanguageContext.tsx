...
const translations = {
  en: {
    ...
    'features.cta.sub': 'Start today with 3 free credits and experience the future of product asset production.',
  ...
  ar: {
    ...
    'features.cta.sub': 'ابدأ اليوم بثلاثة أرصدة مجانية واختبر مستقبل إنتاج أصول المنتجات.',
