...
export default function PrivacyPage() {
  const sections = [
    ...
    },
    {
      ...
      content: "We utilize Google Gemini 3.1 Vision for image analysis and Supabase for authentication and database management. These third-party services are critical to our infrastructure and have their own privacy standards which we monitor for compliance."
    },
    {
      id: "05",
      title: "Data Sharing",
